...
from Code.lib.res2net import GBARES
from Code.lib.cbam import CBAM
################################################
from Code.lib.RCA import RCA
...
class RCA0(nn.Module):    
    def __init__(self,in_dim, out_dim):
        super(RCA0, self).__init__()
...
class SODNet(nn.Module):
    def __init__(self, channel=32):
        ...
        # funsion encoders #
        ###############################################
        self.fu_0 = RCA0(64, 64)
        
        self.fu_1 = RCA(256, 128) 
        self.pool_fu_1 = maxpool()
        
        self.fu_2 = RCA(512, 256)
        self.pool_fu_2 = maxpool()
        
        self.fu_3 = RCA(1024, 512)
        self.pool_fu_3 = maxpool()

        self.fu_4 = RCA(2048, 1024)
    ...
    def forward(self, imgs, depths, bin):
        ...
        #rgb_edge_out     = self.upsample_2(self.rgb_edge_conv_out(x_rgb_02))
        ...
        #ful_edge_out     = self.upsample_2(self.ful_edge_conv_out(x_ful_02))
        ...
        return rgb_out, dep_out, ful_out, out4r, out3r, out2r, out1r, out4d, out3d, out2d, out1d, out4m, out3m, out2m, out1m #, rgb_edge_out, dep_edge_out, ful_edge_out
